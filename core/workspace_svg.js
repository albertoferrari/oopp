...
Blockly.WorkspaceSvg.prototype.onMouseWheel_ = function(e) {
  ...
  // NOTE: This was fixed in a later version of Blockly, but replacing the library here is an hassle
...
Blockly.WorkspaceSvg.prototype.zoom = function(x, y, type) {
  ...
  var reverse = this.options.zoomOptions.reverse;
  var metrics = this.getMetrics();
