...
Blockly.Flyout.prototype.show = function(xmlList) {
  ...
  } else if (xmlList == Blockly.Classes.NAME_TYPE) {
    // Special category for objects.
    xmlList = Blockly.Classes.flyoutCategory(this.workspace_.targetWorkspace);
  } else if (xmlList == Blockly.Interfaces.NAME_TYPE) {
    // Special category for interfaces.
    xmlList = Blockly.Interfaces.flyoutCategory(this.workspace_.targetWorkspace);
  }
