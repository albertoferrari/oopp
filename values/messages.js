...
/// previous lines: standard Google Blockly messages
/// ****************************************************************
/// following lines: messages for Object Oriented Puzzle Programming
/// * @author SoWIDE Lab - DIA University of Parma
Blockly.Msg.OOP_DEFAULTCLASSNAME = 'NewClass';
Blockly.Msg.OOP_INTERFACE_DEFAULT_NAME = 'NewInterface';
Blockly.Msg.OOP_IMPLEMENTS = ' implements ';
Blockly.Msg.OOP_MUTATORCONTAINER_TITLE = ' extends ';
Blockly.Msg.OOP_MUTATORINTERFACE_TITLE = ' implements ';
Blockly.Msg.OOP_MUTATORPACKAGE_TITLE = ' package ';
Blockly.Msg.OOP_MUTATORPACKAGE_DEFAULT = 'com.domain.application';
Blockly.Msg.OOP_AUTHORCOMMENT = '@author';
Blockly.Msg.OOP_CLASS = 'class:';
Blockly.Msg.OOP_INTERFACE = 'interface:';
Blockly.Msg.OOP_PACKAGE = 'package:';
Blockly.Msg.OOP_PUBLIC_INTERFACE = 'public interface ';
Blockly.Msg.OOP_CONSTANT = 'constants:';
Blockly.Msg.OOP_TYPE = 'type:';
Blockly.Msg.OOP_FIELD = 'fields:';
Blockly.Msg.OOP_FIELD_NAME = 'field name:';
Blockly.Msg.OOP_CONSTANT_NAME = 'constant name:';
Blockly.Msg.OOP_CONSTANT_VALUE = 'value:';
Blockly.Msg.OOP_METHOD_NAME = "method name: ";
Blockly.Msg.OOP_CONSTRUCTOR_NAME = 'constructor';
Blockly.Msg.OOP_PARAMETER_NAME = 'parameter name:';
Blockly.Msg.OOP_CONSTRUCTOR = 'constructors:';
Blockly.Msg.OOP_METHOD = 'methods:';
Blockly.Msg.OOP_VISIBILITY = 'visibility:';
Blockly.Msg.OOP_WITH_PARAMETER = "with parameters:";
Blockly.Msg.OOP_RETURN_TYPE = "return type:";
Blockly.Msg.OOP_DESCRIBECLASS = 'Describe this class...';
Blockly.Msg.OOP_DESCRIBEINTERFACE = 'Describe this interface...';
Blockly.Msg.OOP_DESCRIBECONSTRUCTOR = 'Describe this constructor...';
Blockly.Msg.OOP_DESCRIBEMETHOD = 'Describe this method...';
Blockly.Msg.OOP_TOOLTIP_OBJECT_TYPE = 'object type';
Blockly.Msg.OOP_TOOLTIP_METHOD = 'method without return value';
Blockly.Msg.OOP_TOOLTIP_METHOD_RETURN = 'method with return value';
Blockly.Msg.OOP_TOOLTIP_CONSTRUCTOR = 'object constructor';
Blockly.Msg.OOP_TOOLTIP_PARAMETER = 'constructor/method parameter';
Blockly.Msg.OOP_TOOLTIP_FIELD = 'a field';
Blockly.Msg.OOP_TOOLTIP_CONSTANT = 'a constant for the interface';
Blockly.Msg.OOP_TOOLTIP_INTERFACE_SET = 'Interface definition, if it\'s marked as a Library (lib), then its code won\'t be generated';
Blockly.Msg.OOP_TOOLTIP_CLASS_SET = 'Class definition, if it\'s marked as a Library (lib), then its code won\'t be generated';
Blockly.Msg.OOP_TOOLTIP_INTERFACE_GET = 'interface getter';
Blockly.Msg.OOP_TOOLTIP_CLASS_GET = 'class getter';
Blockly.Msg.OOP_ERROR_METHODS = "Error: one or several method(s) are absent from a class"
Blockly.Msg.OOP_ERROR_DETAILS_METHODS = "\n\nDetails : The method(s) "
Blockly.Msg.OOP_ERROR_DETAILS_INTERFACE= " of the interface(s) "
Blockly.Msg.OOP_ERROR_DETAILS_CLASS =" are absent from the class "
Blockly.Msg.OOP_ERROR_DETAILS_OVERCLASS= " or from the class "
Blockly.Msg.OOP_GET_TOOLTIP = "Returns the value of this object.";
/// context menu - Selecting this creates a block to set (change) the value of this object.
/// \n\nParameters:\n* %1 - the name of the object.
Blockly.Msg.OOP_GET_CREATE_SET = 'Create "set %1"';
/// tooltip - This block causes the body (blocks inside) of the named object definition to be run.\n\nParameters:\n* %1 - the name of the object.
Blockly.Msg.OOP_CALLRETURN_TOOLTIP = 'Run the user-defined object "%1" and use its output.';
/// url - Information about using a class
Blockly.Msg.OOP_HELPURL = 'https://www.google.com';
Blockly.Msg.OOP_INSERT_YOUR_CODE = '   // Code... \n';
Blockly.Msg.OOP_CREATE_WITH_CONTAINER_TOOLTIP = 'Add, remove, or reorder sections to reconfigure this class block.';
Blockly.Msg.OOP_CREATE_WITH_CONTAINER_TOOLTIP_INTERFACE = 'Add, remove, or reorder sections to reconfigure this interface block.';
Blockly.Msg.OOP_CREATE_WITH_CLASS_TOOLTIP = 'Extend the current class with another class.';
Blockly.Msg.OOP_CREATE_WITH_INTERFACE_TOOLTIP_INTERFACE = 'Extend the current interface with others interfaces.';
Blockly.Msg.OOP_CREATE_WITH_INTERFACE_TOOLTIP = 'Implement the current class with an interface.';
Blockly.Msg.OOP_CREATE_WITH_CONTAINER_TOOLTIP_VISIBILITY = 'Add or remove the private visibility for this constructor block.';
Blockly.Msg.OOP_CREATE_WITH_PACKAGE_TOOLTIP = 'Set the package for the current class.';
Blockly.Msg.OOP_CREATE_WITH_VISIBILITY_TOOLTIP = 'Add item for private visibility';
Blockly.Msg.OOP_PUBLIC_STATIC_FINAL = 'public static final ';
Blockly.Msg.OOP_CLASS_RENAME = '"%1" class';
Blockly.Msg.OOP_INTERFACE_RENAME = '"%1" interface';

Blockly.Msg.OOP_TYPE_BYTE = 'Byte';
Blockly.Msg.OOP_TYPE_SHORT = 'Number (Short)';
Blockly.Msg.OOP_TYPE_INTEGER = 'Number';
Blockly.Msg.OOP_TYPE_LONG = 'Number (Long)';
Blockly.Msg.OOP_TYPE_FLOAT = 'Real Number (Float)';
Blockly.Msg.OOP_TYPE_DOUBLE = 'Real Number (Double)';
Blockly.Msg.OOP_TYPE_CHAR = 'Character';
...
Blockly.Msg.OOP_ERROR_INVALIDNAME = 'Invalid name';
Blockly.Msg.OOP_ERROR_INVALIDPACKAGENAME = 'Invalid package name';
Blockly.Msg.OOP_STRING = 'String';
Blockly.Msg.OOP_LIB = 'lib:';
